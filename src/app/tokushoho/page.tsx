...
const items = [
  ...
  { label: 'メールアドレス / 連絡先', value: '※お問い合わせいただいた場合、遅滞なく開示いたします。' },
  { label: 'サービス内容', value: 'ブランド品買取業者の比較情報提供（無料コンテンツサービス）' },
  { label: '販売価格', value: '無料（当サービスはユーザーへの課金を行いません）' },
  { label: '支払方法', value: '該当なし（無料サービスのため）' },
  { label: '役務の提供時期', value: '該当なし（当サービスはウェブ上でコンテンツを即時提供します）' },
  { label: 'キャンセルについて', value: '該当なし（無料コンテンツの閲覧のみであり、申し込み・契約関係は発生しません）' },
  {
    label: '古物営業法について',
